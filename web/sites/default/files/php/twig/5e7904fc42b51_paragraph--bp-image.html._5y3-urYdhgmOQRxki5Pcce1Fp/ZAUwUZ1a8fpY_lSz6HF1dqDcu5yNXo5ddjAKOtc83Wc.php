...
class __TwigTemplate_b10c23a8f99761edf1c07f17064644c791fae7238b1e921e4e49ccc3ac528195 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["if" => 45, "set" => 46];
        $filters = ["escape" => 40, "render" => 45, "clean_class" => 129, "merge" => 138, "without" => 153];
...
";
  ...
  <div class=\"paragraph__column\">
    ...
    ";
        ...
        // line 153
        echo "      ";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->withoutFilter($this->sandbox->ensureToStringAllowed(($context["content"] ?? null)), "bp_width", "bp_background", "bp_link"), "html", null, true);
        echo "
    ";
        // line 154
        if ( !twig_test_empty($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->getAttribute(($context["content"] ?? null), "bp_link", [])))) {
